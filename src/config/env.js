...
let previewUrl = 'http://localhost:2828/onlinePreview?url='; // 文件在线 预览页面
...
if (env.NODE_ENV == 'development') {
  ...
  baseUrl = `http://localhost:2828`; // 开发环境地址
  window.baseUrl = `http://192.168.0.114:2828`;
  ...
  previewUrl = 'http://localhost:2828/onlinePreview?url='; // 文件在线 预览页面
