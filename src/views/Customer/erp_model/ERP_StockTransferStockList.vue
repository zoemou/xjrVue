<template>
    ...
    <main-content :title="contentTitle" >
        <div slot="search">
             ...
             <div class="searchBox">
                <el-form label-width="70px"  style="display: inline-block; margin-right: 70px;">
                    <el-form-item  label="调拨编码" style="display: inline-block;">
						<el-input v-model="searchParam.F_TransferCode" size="small" placeholder="请输入调拨编码查询"   style="width:200px" ></el-input>
                    </el-form-item>
                    <el-form-item  label="调拨日期" style="display: inline-block; margin-right: 5px;">
                        <el-date-picker size="small"  type="daterange" value-format="yyyy-MM-dd" v-model="F_TransferDate_Date"   style="width:250px" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" @change="F_TransferDate_DateChange"> </el-date-picker>
                    </el-form-item>
        ...
        <div slot="table">
        <!-- 在此处放置表格内容 -->
            <avue-crud ref="ERP_StockTransferStockTable" :data="listData" @selection-change="selectionChange" id="printTable" :option="option" stripe :page.sync="page"
                       @on-load="onPageLoad"
            ...
            <el-dialog title="表单" :append-to-body="true" :fullscreen="true" :visible.sync="flag"  :class="isWorkflowForm ? 'work-form-dialog' : ''" :show-close="!isWorkflowForm" >
                <ERP_StockTransferStockForm ref="xtForm"  v-if="flag"  :isEdit="isEdit" :disabled="disabled" @onChange="dialogChange" :keyValue="keyValue"></ERP_StockTransferStockForm>
            </el-dialog>
      <el-dialog title="快速导入" width="400px" :append-to-body="true" :visible.sync="excelDialog">
        <el-upload
           ...
           :action="baseUrl + '/erp_stocktransferstock/import'">
...
<script>
     ...
     import MainContent from "@/page/main/MainContent";
      ...
      import ERP_StockTransferStockForm from './ERP_StockTransferStockForm';
     export default {
         name: "ERP_StockTransferStock",
         mixins: [authorizeMixin,tableOptionMixin,schemeMixins],
         components: { MainContent, MainFixed,ERP_StockTransferStockForm,createFlow },
         data() {
			  ...
			  btns:[
				   ...
				   mounted(){
				   	  ...
				   	  if((themeName == "eveningTheme" && window.screen.width<1410)||(themeName != "eveningTheme" &&window.screen.width<1410)){
                   ...
                   methods: {
                         ...
                         download(){
                             request({
                                 ...
                                 responseType: 'blob'
                                    ...
                                    link.href = url;
                                    link.setAttribute('download', 'ERP_StockTransferStock.xlsx');
                         ...
                         getListData() {
                            request({
                                url: baseUrl + '/erp_stocktransferstock',
                                method: 'get',
                         ...
                         searchClick() {
                          ...
                          /* 查询表单重置 */
                         searchReset() {
                       this.searchParam.F_TransferCode = null;
                       this.searchParam.F_TransferDate_Start = null;
                       this.searchParam.F_TransferDate_End = null;
                       this.searchParam.F_TransferDate_Date = null;
                       this.F_TransferDate_Date = [];
                            this.getListData()
                         },
                          /*查看*/
                         viewForm(val) {
...
                           }
                         ...
                         deleteForm(val) {
                            this.$confirm("确定要删除此项吗？", "提示", {
                              ...
                              type: "warning",
                                 ...
                                 request({
                                     url: baseUrl + "/erp_stocktransferstock/" + val.F_Id,
                                     method: "delete",
                                 }).then((res) => {
                                     this.getListData()
                                     this.$notify({
                         ...
                         sortChange(data) {
                          ...
                          /* 导出 */
                          tableExport(){
                            this.$refs["ERP_StockTransferStockTable"].rowExcel()
                            return;
                         },
                           ...
                           batchDelete() {
                            if (!this.ids || this.ids.split(",").length === 0) {
                             ...
                             this.$confirm("确定要批量删除所选项吗？", "提示", {
                               ...
                               request({
                                 url: baseUrl + "/erp_stocktransferstock/" + this.ids,
                                 method: "delete",
                               }).then((res) => {
                                 this.getListData();
                                 this.$notify({
                   ...
                   F_TransferDate_DateChange(val){
                       this.searchParam.F_TransferDate_Start = val[0];
                       this.searchParam.F_TransferDate_End = val[1];
                   },
         }
     }
</script>
