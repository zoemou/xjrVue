    ...
    <el-row :gutter="15">
      <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="100px">
        <el-col :span="12" v-if="hasFormPermission('F_EnCode')">
          <el-form-item label="供应商编号" prop="F_EnCode">
            <el-input v-model="formData['F_EnCode']" placeholder="请输入供应商编号"
        ...
        <el-col :span="12" v-if="hasFormPermission('F_FullName')">
          <el-form-item label="供应商名称" prop="F_FullName">
            <el-input v-model="formData['F_FullName']" placeholder="请输入供应商名称"
        ...
        <el-col :span="12" v-if="hasFormPermission('F_UniCategory')">
          <el-form-item label="供应商类别" prop="F_UniCategory">
            <el-select v-model="formData['F_UniCategory']" placeholder="请选择供应商类别"
        ...
        <el-col :span="12" v-if="hasFormPermission('F_UnitTelephone')">
          <el-form-item label="供应商电话" prop="F_UnitTelephone">
            <el-input v-model="formData['F_UnitTelephone']" placeholder="请输入供应商电话"
        ...
        <el-col :span="12" v-if="hasFormPermission('F_ProvinceId')">
          <el-form-item label="供应商地址" prop="F_ProvinceId">
            <avue-select-area v-if="showForm" v-model="formData['F_ProvinceId']" :clearable="true"
              :disabled="hasDisabledPermission('F_ProvinceId',false)"
              :readonly="!hasEditPermission('F_ProvinceId',undefined)"></avue-select-area>
          </el-form-item>
        </el-col>
        <el-col :span="12" v-if="hasFormPermission('F_UnitAddress')">
          <el-form-item label="地址" prop="F_UnitAddress">
            <el-input v-model="formData['F_UnitAddress']"
        ...
        <el-col :span="24" v-if="hasFormPermission('erp_inoutunitcontact')">
          <avue-form v-loading="preloadLoading120" element-loading-text="数据预加载中..."
            element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.7)"
            :option="option120" v-model="erp_inoutunitcontact" :disabled="disabled">
    ...
    async getF_UniCategoryOptions() {
      ...
      try {
        let resp = await this.$axios({
          method: 'get',
          url:  baseUrl + '/data-items/供应商类别/detail',
        });
        if (resp.data.data) {
