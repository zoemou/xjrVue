<template>
  <div>
    <el-drawer v-bind="$attrs" v-on="$listeners" @opened="onOpen" @close="onClose" :close-on-click-modal="false"
               :modal-append-to-body="false" :append-to-body="true" :destroy-on-close="true">
...
export default {
  ...
  methods: {
    ...
    onOpen () {
      ...
      loadBeautifier(btf => {
        beautifier = btf;
        this.htmlCode = btf.html(this.htmlCode, beautifierConf.html);
        this.jsCode = btf.js(this.jsCode, beautifierConf.js);
        this.cssCode = btf.css(this.cssCode, beautifierConf.html);
    ...
    runCode () {
      ...
      try {
        ...
        if (astBody[0].type === 'ExportDefaultDeclaration') {
          console.log('---runCode---');
          // var $previewApp = this.$refs.previewPage.contentWindow.document.getElementById('app');
          // console.log('ExportDefaultDeclaration', $previewApp);
          const postData = {
            type: 'refreshFrame',
            data: {
          ...
          /* var $previewApp=this.$refs.previewPage.contentWindow.document.getElementById('app');
          console.log('ExportDefaultDeclaration',this.$refs.previewPage.contentWindow,$previewApp);
          this.$refs.previewPage.contentWindow['test'](postData,$previewApp)	 */
