<template>
  <div class="avue-contail"
    ...
    <div class="avue-layout" style="height: calc(100% - 56px);">
       <!-- 左侧导航栏 -->
	...
	dragControllerDiv() {
	    ...
	    for (let i = 0; i < resize.length; i++) {
	        ...
	        resize[i].onmousedown = function (e) {
	            //颜色改变提醒
	            resize[i].style.background = '#bccbfd';
	            ...
	            document.onmousemove = function (e) {
	                ...
	                if (moveLen < 208) moveLen = 208; // 左边区域的最小宽度为32px
	            ...
	            document.onmouseup = function (evt) {
	                //颜色恢复
	                resize[i].style.background = '#3d6beb';
