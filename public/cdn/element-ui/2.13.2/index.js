			...
			watch: {
				visible: function(e) {
					...
					e ? (this.closed = !1, this.$emit("open"), this.$el.addEventListener(
						...
						t.$refs.dialog.style.left = '';
						t.$refs.dialog.style.top = '';
		...
		var gu = r({
			...
			props: {
				...
				texts: {
					type: Array,
					default: function() {
						return [this.$t('veryBad'), this.$t('disappointed'), this.$t('workFlow.WFChange.generally'),this.$t('satisfy'), this.$t('surprised')]
					}
				},
				scoreTemplate: {
					type: String,
